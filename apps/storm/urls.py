...
from .views import (IndexView, DetailView, MessageView, AboutView, SponsorView, ExchangeView, ProjectView, QuestionView, MySearchView, LoveView, LinkView)
...
urlpatterns = [
    ...
    url(r'^category/donate/$', SponsorView, name='donate'),
